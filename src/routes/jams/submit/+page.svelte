...
<section id="main">
    ...
    <Form activeStep={steps[currentActive-1]}/>
    <div class="buttons">
      <button class="btn border-2 border-cinnabar" class:opacity={currentActive == 1} on:click={() => handleProgress(-1)} disabled={currentActive == 1}>Prev</button>
